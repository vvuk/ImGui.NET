...
namespace ImGuiNET
{
    ...
    public unsafe partial struct ImGuiIOPtr
    {
        ...
        public ref float2 DisplayFramebufferScale => ref UnsafeUtility.AsRef<float2>(&NativePtr->DisplayFramebufferScale);
        ...
        public ref float2 MousePos => ref UnsafeUtility.AsRef<float2>(&NativePtr->MousePos);
        ...
        public ref float2 MouseDelta => ref UnsafeUtility.AsRef<float2>(&NativePtr->MouseDelta);
        public ref float2 MousePosPrev => ref UnsafeUtility.AsRef<float2>(&NativePtr->MousePosPrev);
